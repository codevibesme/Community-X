...
const UserOptions = () => {
  ...
  return (
    <footer className="w-full flex flex-col h-full justify-end ">
        ...
        <div onClick={showUserOptions} className="flex text-bold text-xl rounded-xl border-gray-700 border-2 h-fit p-2 bg-black active:scale-95 hover:bg-slate-800">
